...
def select_theme_popup():
    ...
    return selected_theme.get('theme', 'anime')  # default if none selected
...
def main():
    ...
    # Ask user to pick a theme before proceeding
    user_theme = select_theme_popup()

    # Load theme assets/colors based on choice
    ...
    # === Load Last City and Fetch Weather if available ===
